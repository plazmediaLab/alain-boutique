...
export default function SignUp(){
  ...
  return(
    <Layout>
      <section className="flex flex-col justify-center items-center bg-background relative min-h-screen px-12">
        ...
        <Link to="/" className="text-p_blue-500 mb-4">Inicia sesión</Link>
